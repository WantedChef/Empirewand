...
public interface EffectService extends EmpireWandService {
     ...
     */
    @MainThread
    void impact(@NotNull Location location, @NotNull Particle particle, int count, @NotNull Sound sound, float volume,
            float pitch);
     ...
     */
    @MainThread
    void followParticles(@NotNull Plugin plugin, @NotNull org.bukkit.entity.Entity entity, @NotNull Particle particle,
            int count, double offsetX, double offsetY, double offsetZ, double speed, Object data, long periodTicks);
    ...
    /**
     * Shows a success message to a player using the configured success message system.
     *
    ...
    /**
     * Shows an informational message to a player using the configured info message system.
     *
