package nl.wantedchef.empirewand.spell.enhanced.movement;
...
/**
 * A devastating spell that creates a black hole,
 * pulling in all entities and crushing them with immense gravitational force.
 */
public class BlackHole extends Spell<Void> {
    ...
    public static class Builder extends Spell.Builder<Void> {
        public Builder(EmpireWandAPI api) {
            ...
            this.description = "Creates a devastating black hole that pulls in all entities and crushes them with immense gravitational force.";
    ...
    private static class BlackHoleTask extends BukkitRunnable {
        ...
        public BlackHoleTask(SpellContext context, Location center, double radius, 
                            int durationTicks, boolean affectsPlayers, 
        ...
        private void applyBlackHoleEffects() {
            ...
            for (Entity entity : nearbyEntities) {
                ...
                if (consumedEntities.contains(entity)) continue;
                ...
                if (ticks % 3 == 0) {
                    world.spawnParticle(Particle.SQUID_INK, entity.getLocation().add(0, 1, 0), 3, 0.2, 0.3, 0.2, 0.01);
                }
            }
        }

        private void consumeEntity(Entity entity) {
            if (consumedEntities.contains(entity)) return;
            ...
            if (entity instanceof LivingEntity) {
                ((LivingEntity) entity).damage(1000.0, context.caster()); // Massive damage to ensure death
            }
