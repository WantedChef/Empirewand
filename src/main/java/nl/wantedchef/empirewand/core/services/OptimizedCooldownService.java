 ...
 * <p>
 * This implementation uses `fastutil` collections to reduce memory overhead and
 * improve access speed.
 * It features a periodic cleanup task to remove expired cooldowns, preventing
...
public class OptimizedCooldownService {
    ...
    /**
     * Shuts down the cooldown service, stopping the cleanup task and clearing all
     * data.
     */
     ...
     * @param totalCooldowns    The total number of active cooldowns across all
     *                          players.
     * @param disabledCooldowns The number of player-wand combinations with disabled
     *                          cooldowns.
     */
