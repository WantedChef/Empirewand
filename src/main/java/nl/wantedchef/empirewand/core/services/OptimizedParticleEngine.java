...
/**
 * An enhanced particle engine featuring object pooling and optimized batching
 * for high-performance particle rendering.
 * This engine is designed to handle a large volume of particle effects with
...
public class OptimizedParticleEngine {
    ...
    private static class ParticleBatchPool {
        ...
        /**
         * Borrows a ParticleBatch from the pool or creates a new one if the pool is
         * empty.
         *
     ...
     * @param particlesPerBlock The number of particles to spawn per block of
     *                          distance.
     */
    ...
    /**
     * Shuts down the particle engine, stopping the cleanup task and flushing any
     * remaining particles.
     */
     ...
     *
     * @param totalParticlesSpawned The total number of particles spawned since
     *                              startup.
     * @param activeBatches         The number of batches currently waiting to be
     *                              flushed.
     * @param poolSize              The number of available objects in the batch
     *                              pool.
     */
